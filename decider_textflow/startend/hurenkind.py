...
HURENKIND_BEFORE = configo.HV_INT_PLUS(default=120)

HURENKIND_LINEWIDTH = configo.HV_PERCENT_PLUS(default=90)

SECOND_FULL_LINE_DIFF_MAX = configo.HV_FLOAT_PLUS(default=5.0)
